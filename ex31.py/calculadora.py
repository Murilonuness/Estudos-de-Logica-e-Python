class Calculadora:
    ...
    def calcular_area_paredes(self, comodo):
        self.__area_paredes = 2 * (comodo.largura + comodo.profundidade) * comodo.alt
    ...
    def calcular_litragem_necessaria(self, comodo): 
        if self.__area_paredes <= 0 or self.__area_teto <= 0:
            print(
                "Não é possível calcular a litragem com os valores informados."
                )
            exit()
        return (self.__area_paredes + self.__area_teto) / comodo.rendimento_tinta